      ...
      {username ? (
        <div className="flex items-center gap-8">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-full transition-all cursor-pointer font-semibold text-lg ${
              isHovered
        ...
        <Link
          to="/auth"
          className="px-5 py-2.5 bg-yellow-500 text-neutral-950 font-semibold text-lg rounded-full hover:bg-yellow-400 transition-colors cursor-pointer"
        >
          Login / Sign Up
        </Link>
      )}
